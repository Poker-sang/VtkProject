...
public class TypeWithAttributeGenerator : IIncrementalGenerator
{
    ...
    {
        { "Manager.Attributes.GenerateConstructorAttribute", TypeWithAttributeDelegates.GenerateConstructor },
        { "Manager.Attributes.LoadSaveConfigurationAttribute`1", TypeWithAttributeDelegates.LoadSaveConfiguration },
        { "Manager.Attributes.DependencyPropertyAttribute`1", TypeWithAttributeDelegates.DependencyProperty }
    };
